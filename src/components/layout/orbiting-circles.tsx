  ...
  (
    {
      ...
      reverse = false,
      icons = [],
      iconSize, // Destructure to prevent DOM warning
      className,
      children,
      ...props
    },
    ...
    return (
      ...
      >
        {/* Center element */}
        <div className="absolute z-10 flex h-16 w-16 items-center justify-center rounded-full border-2 border-border bg-card">
        ...
        {content.map((item, i) => {
          ...
          return (
            <motion.div
              key={i}
              className="absolute flex h-12 w-12 items-center justify-center rounded-full border border-border bg-card shadow-md"
              style={{
                transformOrigin: "0 0",
              }}
              animate={{
