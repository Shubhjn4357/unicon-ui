  ...
  ({ text, className, ...props }, ref) => {
    return (
      ...
      >
        ...
        <span
          className="absolute top-0 left-0 -z-10 translate-x-[2px] text-destructive opacity-70 animate-pulse"
          style={{ clipPath: "polygon(0 0, 100% 0, 100% 45%, 0 45%)" }}
        >
          {text}
        </span>
        <span
          className="absolute top-0 left-0 -z-10 -translate-x-[2px] text-primary opacity-70 animate-pulse"
          style={{
