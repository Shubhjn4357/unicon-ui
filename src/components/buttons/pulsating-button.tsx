  ...
  (
    ...
    return (
      <motion.button
        ref={ref}
        className={cn(
          "relative inline-flex h-11 items-center justify-center rounded-lg bg-[hsl(var(--primary))] px-8 font-medium text-white",
          className
        )}
  ...
  ({ children, className, ...props }, ref) => {
    ...
    return (
      <motion.button
        ref={ref}
        className={cn(
          "relative inline-flex h-11 items-center justify-center overflow-hidden rounded-lg bg-[hsl(var(--primary))] px-8 font-medium text-white",
          className
        )}
        onClick={handleClick}
