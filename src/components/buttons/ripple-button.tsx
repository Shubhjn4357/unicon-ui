...
const RippleButton = React.forwardRef<HTMLButtonElement, RippleButtonProps>(
  (
    ...
    return (
      <button
        className={cn(
          "relative flex cursor-pointer items-center justify-center overflow-hidden rounded-lg border-2 bg-[hsl(var(--primary))] px-6 py-3 text-center text-white shadow-sm transition-all duration-300 hover:scale-[0.98]",
          className
        )}
        onClick={handleClick}
        ref={ref}
